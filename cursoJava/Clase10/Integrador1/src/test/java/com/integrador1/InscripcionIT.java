...
public class InscripcionIT {
     ...
     */
        ...
        //     Inscripcion instance = new Inscripcion();
        //     instance.setAlumno(new Alumno("Luciana",  null));

        //     instance.setMateria(new Materia("Matematica 2",  new ArrayList<>()));
        //     instance.getMateria().getCorrelativas().add(new Materia("Matematica 1",  null));
