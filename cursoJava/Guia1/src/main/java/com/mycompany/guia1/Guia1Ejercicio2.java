...
public class Guia1Ejercicio2 {
    public static void main(String[] args) {
        ...
        System.out.println("Por favor, responda las siguientes preguntas "
                + "considerando para ello a todos los integrantes del "
                + "grupo familiar: ");
    ...
    public static boolean ingresos(){
        String input = JOptionPane.showInputDialog("¿Cuáles son los "
    ...
    public static boolean vehiculos(){
        ...
        public static boolean suntuosos(){
            String input_suntuosos = JOptionPane.showInputDialog("Posee al menos "
                + "uno de los siguientes items?: \n - embarcación, \n -aeronave "
                + "de lujo, \n titularidad de activos societarios que "
